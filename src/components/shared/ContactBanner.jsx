...
export default function ContactBanner({ wide = false }) {
  ...
  return (
    ...
    >
      <motion.section
        ...
        className="w-full overflow-hidden rounded-[2rem] bg-[#46C54B] text-white shadow-[0_24px_70px_-36px_rgba(34,126,42,0.45)]"
      >
