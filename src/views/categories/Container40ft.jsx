    ...
    <div className="pt-20 lg:pt-24 pb-20 min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-1.5 text-xs text-muted-foreground mb-6">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-foreground font-medium">40 Fuß Container</span>
        </nav>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <h1 className="font-heading font-bold text-3xl lg:text-4xl tracking-tight mb-3">
            40 Fuß Container kaufen
          </h1>
          <p className="text-muted-foreground max-w-2xl">
            Maximaler Stauraum mit ca. 67 m³ Volumen – ideal für große Projekte, professionelle Lagerung und Wohn- oder Büroausbauten. Gebraucht ab 2.990 €, neu ab 3.990 €.
          </p>
          <div className="mt-3 text-sm text-muted-foreground">
            <Link to="/40-fuss-container-kaufen" className="text-orange-500 hover:underline">
              → Ratgeber: 40 Fuß Container – Maße, Typen & Preise
            </Link>
          </div>
        </motion.div>
