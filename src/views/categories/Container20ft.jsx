    ...
    <div className="pt-20 lg:pt-24 pb-20 min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-1.5 text-xs text-muted-foreground mb-6">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-foreground font-medium">20 Fuß Container</span>
        </nav>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <h1 className="font-heading font-bold text-3xl lg:text-4xl tracking-tight mb-3">
            20 Fuß Container kaufen
          </h1>
          <p className="text-muted-foreground max-w-2xl">
            Der meistverkaufte ISO-Seecontainer weltweit – ca. 33 m³ Volumen, ideal als Lager, Werkstatt oder für den Transport. Gebraucht ab 1.990 €, neu ab 2.490 €.
          </p>
          <div className="mt-3 text-sm text-muted-foreground">
            <Link to="/20-fuss-container-kaufen" className="text-orange-500 hover:underline">
              → Ratgeber: 20 Fuß Container – Maße, Gewicht & Preise
            </Link>
          </div>
        </motion.div>
