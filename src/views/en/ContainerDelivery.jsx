  ...
  return (
    <div className="pt-20 lg:pt-24 pb-20 bg-background min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <span className="font-mono text-xs tracking-widest uppercase mb-3 block" style={{ color: "#278A2F" }}>Delivery service</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            {DELIVERY_STEPS.map((s, i) => (
              <div key={i} className="flex gap-3 p-4 bg-card rounded-xl border border-border">
                <s.icon className="w-5 h-5 shrink-0 mt-0.5" style={{ color: "#278A2F" }} />
                <div>
