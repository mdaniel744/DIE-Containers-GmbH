...
const FACTORS = [
  ...
  { icon: MapPin, title: "Standort & Lieferung", desc: "Transportkosten starten ab ca. 250 € und steigen mit Entfernung und Zugangsbedingungen." },
  ...
  return (
    <div className="pt-20 lg:pt-24 pb-20 bg-background min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ── Container kaufen leicht gemacht ── */}
        ...
        {/* ── Welche Container kann man kaufen? ── */}
        <section className="mb-16">
