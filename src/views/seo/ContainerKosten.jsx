...
const PRICING_GRID = [
  {
    ...
    cols: [
      ...
      { label: "Multi Trip (Leicht gebraucht)", price: "2.000 – 2.600 €", desc: "Wenige Einsätze, guter Zustand", badge: null },
      { label: "Gebraucht", price: "1.500 – 2.100 €", desc: "Mehrfach eingesetzt, voll funktionsfähig", badge: "Günstigste Option" },
    ],
  },
  {
    ...
    cols: [
      ...
      { label: "Multi Trip (Leicht gebraucht)", price: "2.400 – 3.200 €", desc: "1–3 Seereisen, guter Zustand", badge: null },
      { label: "Gebraucht", price: "1.990 – 2.900 €", desc: "Meistgekauft, geprüfte Qualität", badge: "Beliebt" },
    ],
  },
  {
    ...
    cols: [
      ...
      { label: "Multi Trip (Leicht gebraucht)", price: "3.800 – 5.000 €", desc: "Sehr guter Zustand", badge: null },
      { label: "Gebraucht", price: "2.990 – 4.200 €", desc: "Bewährt & wetterfest", badge: "Günstigste Option" },
    ],
  },
];
...
const FACTORS = [
  ...
  { icon: Truck, title: "Transportkosten", desc: "Lieferkosten starten ab ca. 250 € und steigen mit der Entfernung. Engstellen oder besondere Zufahrten erhöhen den Preis." },
...
/* ── FAQ ── */
const FAQS = [
  { q: "Was kostet ein 20 Fuß Container?", a: "Ein gebrauchter 20 Fuß Seecontainer kostet ab ca. 1.990 €. Ein One Trip Container (nahezu neu) beginnt bei ca. 3.200 €. Hinzu kommen Transportkosten von ca. 300–600 € je nach Entfernung. Der Gesamtpreis liegt somit meist zwischen 2.300 € und 4.800 €." },
  { q: "Wie viel kostet ein gebrauchter Seecontainer?", a: "Gebrauchte Seecontainer beginnen bei 1.500 € für 10ft-Modelle, ca. 1.990 € für 20ft und ab 2.990 € für 40ft Container. Entscheidend für den Preis sind Zustand, Alter und regionale Verfügbarkeit." },
  ...
  { q: "Sind Transportkosten im Preis enthalten?", a: "Nein, in der Regel werden Container-Kaufpreis und Lieferkosten separat ausgewiesen. Die Transportkosten richten sich nach Entfernung und Zugangssituation und starten ab ca. 250 € für kurze Strecken." },
        ...
        <section className="mb-16 prose-section">
          <div className="space-y-10 text-sm text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <p className="mt-3">
                Als Richtwert: Ein gebrauchter <Link to="/20-fuss-container-kaufen" className="font-semibold underline" style={{ color: ORANGE }}>20 Fuß Container</Link> kostet ab ca. 1.990 €, ein neuer One Trip Container ab ca. 3.200 €. Der <strong className="text-foreground">20 Fuß Container Preis</strong> macht ihn zum beliebtesten Modell – er bietet das beste Preis-Leistungsverhältnis für Lager, Baustellen und gewerbliche Anwendungen.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="overflow-x-auto rounded-xl border border-border my-4">
                <table className="w-full text-xs">
                  ...
                  <tbody>
                    {[
                      ["Bis 50 km", "250–400 €", "350–550 €"],
                      ["50–150 km", "400–650 €", "550–850 €"],
                      ["150–300 km", "650–900 €", "850–1.150 €"],
            ...
            <div className="rounded-2xl border border-border overflow-hidden">
              ...
              <div className="divide-y divide-border">
                {[
                  { label: "Container Kaufpreis (20ft, gebraucht)", value: "1.990 €" },
                  { label: "Transport (ca. 100 km)", value: "ca. 450 €" },
                  { label: "Fundament (4 Betonsteine)", value: "ca. 50 €" },
                ].map((item, i) => (
                ...
                <div className="flex items-center justify-between px-6 py-4" style={{ background: `${NAVY}10` }}>
                  ...
                  <span className="font-heading font-bold text-lg" style={{ color: NAVY }}>ca. 2.490 €</span>
                </div>
              </div>
            </div>
