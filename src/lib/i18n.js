...
const strings = {
  de: {
    ...
    footer: {
      ...
      info: "Informationen",
      legal: "Rechtliches",
      tagline: "Seit 2014 Ihr zuverlässiger Partner für neue und gebrauchte Seecontainer – deutschlandweit lieferbar innerhalb von 72 Stunden.",
    ...
    aboutSection: {
      label: "Über CSAV Container",
      title1: "Hamburgs führender ",
      titleColored: "Containeranbieter",
      title2: " seit 2014",
      body1: "CSAV Container wurde 2014 gegründet und hat sich zu einem der führenden Anbieter von Seecontainern in Deutschland und Europa entwickelt. Mit über 10 Jahren Erfahrung bieten wir maßgeschneiderte Lösungen für Lagerung, Transport und individuelle Containerumbauten.",
      body2: "Von Standard-Lagercontainern bis hin zu Kühl- und Bürocontainern – unser Team berät Sie persönlich und liefert mit eigenem Kran zuverlässig innerhalb von 72 Stunden an Ihren Wunschort.",
      cta: "Mehr über uns",
      highlights: [
        { value: "10+", label: "Jahre Erfahrung", desc: "Seit 2014 Ihr Partner im Containerhandel" },
        { value: "72h", label: "Lieferung", desc: "Deutschlandweiter Versand mit eigenem Kran" },
        { value: "500+", label: "Container auf Lager", desc: "Neu, gebraucht & generalüberholt" },
        { value: "100%", label: "Qualitätsgeprüft", desc: "Jeder Container vor Auslieferung geprüft" },
      ],
    },
    ...
    contact: {
      ...
      infoItems: [
        { label: "Telefon", value: "+49 151 243 71427", href: "tel:+491512437142" },
        { label: "E-Mail", value: "verkauf@csavcontainers.com", href: "mailto:verkauf@csavcontainers.com" },
        { label: "Adresse", value: "Ballindamm 27, 20095 Hamburg" },
    ...
    about: {
      ...
      trustTitle: "Warum CSAV Container?",
      trustItems: [
        ...
        { title: "Erfahrung", desc: "Mit über 10 Jahren Erfahrung im Containerhandel bieten wir ein breites Spektrum an Containerlösungen – von Lager- und Transportcontainern bis hin zu maßgeschneiderten Konzepten für Umbauten und Sonderprojekte." },
        { title: "Unser Team", desc: "Hinter CSAV Container steht ein engagiertes Team aus erfahrenen Fachleuten. Wir arbeiten strukturiert und lösungsorientiert und sind stets bestrebt, für jede Anforderung die bestmögliche Lösung zu finden." },
      ...
      values: [
        ...
        { title: "72h Lieferung", desc: "Mit eigenem Kran liefern wir innerhalb von 72 Stunden deutschlandweit." },
        { title: "Seit 2014", desc: "Über 10 Jahre Expertise im Containerhandel – neu, gebraucht und maßgeschneidert." },
      ],
    },
    ...
    productDetail: {
      ...
      seoPara5: "Lieferung & Service: CSAV Container liefert deutschlandweit mit eigenem Kranfahrzeug innerhalb von 72 Stunden direkt an Ihren Wunschort – inklusive fachmännischer Abladeberatung. Unser Team berät Sie kostenlos zu Untergrundbeschaffenheit, Aufstellgenehmigungen und individuellen Umbauwünschen. Fordern Sie jetzt Ihr unverbindliches Angebot an.",
      metaFallback: (title, price) => `${title} kaufen – wind- und wasserdichter ISO-Stahlcontainer von CSAV Container. Ab ${price} €, deutschlandweite Lieferung.`,
    },
  ...
  en: {
    ...
    footer: {
      ...
      info: "Information",
      legal: "Legal",
      tagline: "Since 2014 your reliable partner for new and used shipping containers — delivered across Germany within 72 hours.",
    ...
    whyChooseUs: {
      label: "Benefits",
      title: "Why Container Germany?",
      description: "Your reliable partner for shipping containers in Germany for years.",
      features: [
    ...
    aboutSection: {
      label: "About CSAV Container",
      title1: "Hamburg's leading ",
      titleColored: "container provider",
      title2: " since 2014",
      body1: "CSAV Container was founded in 2014 and has grown into one of the leading providers of shipping containers in Germany and Europe. With over 10 years of experience, we offer tailored solutions for storage, transport and individual container conversions.",
      body2: "From standard storage containers to refrigerated and office containers – our team provides personal advice and delivers reliably within 72 hours to your desired location using our own crane.",
      cta: "More about us",
      highlights: [
        { value: "10+", label: "Years of experience", desc: "Your partner in container trade since 2014" },
        { value: "72h", label: "Delivery", desc: "Nationwide shipping with own crane" },
        { value: "500+", label: "Containers in stock", desc: "New, used & refurbished" },
        { value: "100%", label: "Quality checked", desc: "Every container inspected before delivery" },
      ],
    },
    ...
    contact: {
      ...
      infoItems: [
        { label: "Phone", value: "+49 151 243 71427", href: "tel:+491512437142" },
        { label: "Email", value: "verkauf@csavcontainers.com", href: "mailto:verkauf@csavcontainers.com" },
        { label: "Address", value: "Ballindamm 27, 20095 Hamburg" },
    ...
    about: {
      label: "About us",
      title: "CSAV Container – Your partner for ",
      titleColored: "shipping containers",
      title2: " since 2014",
      body: "CSAV Container was founded in 2014 and specialises in the sale of new and used shipping containers in Germany and Europe. From our headquarters we offer tailored solutions – from storage containers to individual modules – and deliver with our own crane within 72 hours throughout Germany.",
      imgAlt: "Container delivery",
      stats: [
        { value: "2014", label: "Founded" },
        { value: "10+", label: "Years of experience" },
        { value: "500+", label: "Containers in stock" },
        { value: "72h", label: "Delivery time nationwide" },
      ],
      trustLabel: "Trust",
      trustTitle: "Why CSAV Container?",
      trustItems: [
        ...
        { title: "Experience", desc: "With over 10 years of experience in container trading we offer a broad range of container solutions – from storage and transport containers to tailored concepts for conversions and special projects." },
        { title: "Our team", desc: "Behind CSAV Container stands a dedicated team of experienced specialists. We work in a structured and solution-oriented way, always striving to find the best possible solution for every requirement." },
      ...
      values: [
        ...
        { title: "72h delivery", desc: "With our own crane we deliver within 72 hours throughout Germany." },
        { title: "Since 2014", desc: "Over 10 years of expertise in container trading – new, used and customised." },
      ],
    },
    ...
    productDetail: {
      ...
      seoPara5: "Delivery & service: CSAV Container delivers throughout Germany with its own crane vehicle within 72 hours directly to your desired location – including professional unloading advice. Our team provides free advice on ground conditions, permits and conversion wishes. Request your non-binding quote now.",
      metaFallback: (title, price) => `${title} – waterproof and windproof ISO steel container from CSAV Container. From €${price}, nationwide delivery.`,
    },
