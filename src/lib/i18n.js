...
const strings = {
  de: {
    ...
    quote: {
      ...
      sizes: [
        { value: "10ft", label: "10 Fuß" },
        { value: "20ft", label: "20 Fuß" },
        { value: "40ft", label: "40 Fuß" },
      ],
      heightVariants: [
        { value: "Standard", label: "Standardhöhe" },
      ...
      step3Sub: "Damit wir Ihnen ein individuelles Angebot zusenden und die Lieferung korrekt planen können.",
      nameLabel2: "Name",
      namePlaceholder2: "Max Mustermann",
      ...
      deliveryAddressHint: "Diese Angaben sind für die gewählte Lieferung erforderlich. Bitte geben Sie die Adresse des vorgesehenen Lieferortes an.",
      streetLabel: "Straße",
      streetPlaceholder: "Hermann-Oberth-Str.",
      houseNumberLabel: "Hausnummer",
      postalCodeLabel: "PLZ",
      postalCodeError: "Bitte geben Sie eine fünfstellige deutsche PLZ ein.",
      cityLabel: "Ort",
      cityPlaceholder: "Putzbrunn",
      countryLabel: "Land",
    ...
    about: {
      label: "Über uns",
      title: "DIE Container GmbH – faire Containerlösungen aus ",
      titleColored: "Putzbrunn",
      title2: " für ganz Deutschland",
      body: "DIE Container GmbH ist ein spezialisierter Händler für Seecontainer mit Sitz in Putzbrunn. Wir stehen für faire Preise, geprüfte Qualität und eine zuverlässige Lieferung in ganz Deutschland. Unser Anspruch ist es, den Containerkauf klar, transparent und persönlich zu gestalten – von der ersten Anfrage bis zur Lieferung an Ihren Standort.",
      imgAlt: "Container Lieferung",
      stats: [
        { value: "12+", label: "Jahre Branchenerfahrung" },
        { value: "16", label: "Bundesländer belieferbar" },
        { value: "ISO/CSC", label: "Geprüfte Containerqualität" },
        { value: "Direkt", label: "Persönlicher Ansprechpartner" },
      ],
      trustLabel: "Über uns",
      trustTitle: "Erfahrung aus Logistik, Handel und internationalen Lieferketten",
      trustItems: [
        { title: "Internationales Know-how", desc: "Wir arbeiten mit Logistikexperten zusammen, die mehr als 12 Jahre internationale Erfahrung in Europa, Asien und Afrika mitbringen." },
        { title: "Praxisnahes Verständnis", desc: "Globale Lieferketten, Containerqualität, Transport und Aufstellung kennen wir aus der Praxis. Dieses Wissen hilft uns, realistische und belastbare Lösungen zu empfehlen." },
        { title: "Für Privat- und Geschäftskunden", desc: "Wir unterstützen private Kunden, die einen Lagercontainer für Garten oder Grundstück suchen, genauso wie Unternehmen mit individuellen Containeranforderungen." },
        { title: "Klare Beratung statt Standardantworten", desc: "Jedes Projekt wird nach Bedarf, Standort und Einsatzzweck betrachtet. So erhalten Sie eine Lösung, die wirklich zu Ihrem Vorhaben passt." },
      ],
      valuesLabel: "Was wir tun",
      valuesTitle: "Begleitung vom ersten Gespräch bis zur Lieferung",
      valuesIntro: "DIE Container GmbH begleitet Sie strukturiert durch den gesamten Containerkauf – persönlich, transparent und ohne unnötige Umwege.",
      values: [
        { title: "Beratung & Bedarfsanalyse", desc: "Wir klären kostenlos und unverbindlich, welcher Container zu Nutzung, Platzbedarf und Standort passt." },
        { title: "Passende Containerwahl", desc: "Ob neu, gebraucht oder One-Trip: Wir helfen bei der Auswahl der passenden Größe, Ausführung und Qualität." },
        { title: "Transport & Lieferung", desc: "Wir organisieren die deutschlandweite Lieferung und stimmen die Logistik auf Zufahrt, Stellfläche und Entladung ab." },
        { title: "Renovierung & Umbau", desc: "Auf Wunsch begleiten wir Anpassungen wie Türen, Fenster, Elektroinstallation, Lackierung oder weitere Modifikationen." },
        { title: "Persönliche Betreuung", desc: "Sie sprechen direkt mit einem Ansprechpartner – ohne Callcenter und ohne unnötige Weiterleitungen." },
      ],
      whyLabel: "Warum wir?",
      whyTitle: "Warum Kunden DIE Container GmbH wählen",
      whyItems: [
        { title: "Erfahrenes Team", desc: "Über 12 Jahre Branchenwissen in Logistik, internationalem Handel und Containerlösungen fließen in unsere Beratung ein." },
        { title: "Faire Preise", desc: "Durch direkten Bezug und schlanke Abläufe vermeiden wir unnötige Zwischenhändler und halten Angebote nachvollziehbar." },
        { title: "Geprüfte Qualität", desc: "Jeder Container wird vor dem Verkauf geprüft und entspricht je nach Einsatz den relevanten ISO- und CSC-Anforderungen." },
        { title: "Schnelle Lieferung", desc: "Durch ein bundesweites Depotnetz können Lieferwege kurz gehalten und Termine zuverlässig geplant werden." },
        { title: "Persönliche Beratung", desc: "Vom ersten Kontakt bis zur Auslieferung behalten Sie einen direkten Ansprechpartner für Fragen, Planung und Abstimmung." },
      ],
      locationLabel: "Unser Standort",
      locationTitle: "In Putzbrunn zuhause – deutschlandweit im Einsatz",
  ...
  en: {
    ...
    quote: {
      ...
      step3Sub: "So we can send your personalised quote and plan delivery correctly.",
      nameLabel2: "Name",
      ...
      deliveryAddressHint: "These details are required for the selected delivery option. Enter the address of the intended delivery location.",
      streetLabel: "Street",
      streetPlaceholder: "Hermann-Oberth-Str.",
      houseNumberLabel: "House number",
      postalCodeLabel: "Postcode",
      postalCodeError: "Enter a valid five-digit German postcode.",
      cityLabel: "City",
      cityPlaceholder: "Putzbrunn",
