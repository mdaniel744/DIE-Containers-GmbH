...
const withPWA = withPWAInit({
  ...
  workboxOptions: {
    ...
    runtimeCaching: [
      {
        // Responsive variants generated by next/image. The URL contains the
        // source path, requested width and quality, so cache-first is safe.
        urlPattern: /\/_next\/image\?url=.*/i,
        handler: "CacheFirst",
        options: {
          cacheName: "next-image-cache",
          expiration: { maxEntries: 192, maxAgeSeconds: 60 * 60 * 24 * 30 },
